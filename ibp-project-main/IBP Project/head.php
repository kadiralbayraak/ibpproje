...
<!-- Navbar -->
<header>
    <a href="#" class="logo"><img src="images/logo.png" alt="">YBY Restaurant</a>
    ...
    <ul class="navbar">
        ...
        <li><a href="rent.php" <?php if($Page=="rent") echo "active"?>target="_blank">Rent</a></li>
    ...
    <div class="icons">
        <a href="login.php" class="fas fa-user-alt" target="_blank"><Label>login</Label></a>
    </div>
</header>
